export const GAME_CONFIG = {
  ...
  finalCode: 'FINAL99',
  teams: [
    { id: 'red', name: 'Team Red', color: '#ff5c72', emoji: '🔴', pin: '1234', route: ['basement', 'notice_board', 'nss', 'core_member', 'procore'] },
    { id: 'blue', name: 'Team Blue', color: '#55a8ff', emoji: '🔵', pin: '2345', route: ['nss', 'core_member', 'basement', 'notice_board', 'procore'] },
    { id: 'green', name: 'Team Green', color: '#52d39b', emoji: '🟢', pin: '3456', route: ['notice_board', 'basement', 'core_member', 'nss', 'procore'] },
    { id: 'yellow', name: 'Team Yellow', color: '#ffc857', emoji: '🟡', pin: '4567', route: ['core_member', 'nss', 'notice_board', 'basement', 'procore'] },
    { id: 'purple', name: 'Team Purple', color: '#b58cff', emoji: '🟣', pin: '5678', route: ['basement', 'nss', 'core_member', 'notice_board', 'procore'] }
  ],
  locations: {
    ...
    core_member: { name: 'CORE Member', shortName: 'CORE Member', code: 'MEMBER51', clue: 'You’ve come this far, the end is near, The final answer now appears. Seek not the crowd, but those who lead, The club’s core is where you need.  Find the ones who make things run, For your hunt is nearly done. Go where the heart of the club beats true— Your final treasure awaits with the crew.' }
  },
  riddles: {
    red: [['(15 × 2) + 8 − 11 = ?', 27], ['(48 ÷ 6) + 11 = ?', 19], ['(7 × 8) + 7 = ?', 63], ['(100 ÷ 4) + 26 = ?', 51], ['(9 × 9) − 39 = ?', 42]],
    blue: [['(18 + 6) ÷ 3 + 55 = ?', 63], ['(64 ÷ 8) + 43 = ?', 51], ['(6 × 9) − 27 = ?', 27], ['(8² ÷ 4) + 3 = ?', 19], ['(11 × 7) − 35 = ?', 42]],
    green: [['(9 × 4) − 17 = ?', 19], ['(72 ÷ 8) + 18 = ?', 27], ['(13 × 5) − 14 = ?', 51], ['(12² ÷ 6) + 39 = ?', 63], ['(8 × 8) − 22 = ?', 42]],
    yellow: [['(18 × 3) − 3 = ?', 51], ['(96 ÷ 12) + 55 = ?', 63], ['(7 × 9) − 44 = ?', 19], ['(125 ÷ 5) + 2 = ?', 27], ['(14 × 6) − 42 = ?', 42]],
    purple: [['(16 × 2) − 5 = ?', 27], ['(81 ÷ 9) + 54 = ?', 63], ['(12 × 6) − 21 = ?', 51], ['(160 ÷ 8) − 1 = ?', 19], ['(9 × 7) − 21 = ?', 42]]
